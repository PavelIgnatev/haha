...
export default class TelegramChat {
    ...
    private parseUsers;
    addUser(id?: number, name?: string, participated?: boolean): TelegramUser;
    findUserById(id: number): undefined | TelegramUser;
    findUserByName(name: string): undefined | TelegramUser;
    addOrFindUser(hasId?: number, hasName?: string, hasParticipated?: boolean): TelegramUser;
    private parseContent;
    messageByID(id: number): TelegramMessage | undefined;
    get isBot(): boolean;
    get isPublic(): boolean;
    get isPrivate(): boolean;
    get isPrivateGroup(): boolean;
    get isPublicSupergroup(): boolean;
    get isGroup(): boolean;
    get isSaved(): boolean;
